...
A = imread('lena256.jpg');                   % Ler a imagem original
A = double(A([120:169],[120:179]));          % selecionar a área da imagem
...
s1 = l1qc_logbarrier(s2, Theta, [], y, 5e-3, 1e-3); % L1-magic toolbox
